...
router.get('/', function (req, res, next) {
    AttributesGroups.getAll('group_name _id', function (err, groups) {
        res.render('attributes_groups/groups/groups', {AttributesGroups: groups});
    });
});
...
router.get('/view/:id', function (req, res, next) {
    ...
    groupAttributes.getAttributes(function (err, attributes) {
        res.render('attributes_groups/groups/group_attributes_list', {Attributes: attributes, group_id: req.params.id});
    });
});
